...
- فرشته‌ها/سیگنال‌ها با sprite تصویریِ سینمایی، alpha/luma key، مه و رد حرکت نرم رندر می‌شوند؛ دیگر مدل low-poly یا بال‌های چندضلعی ندارند.
- اپتیک به یک برجک/سامانهٔ واقعی محدود شده است: میدان دید در حالت عادی ۲۸ درجه است، زوم تا `x3.2` می‌رود و yaw/pitch آزادِ ۳۶۰ درجه نیست.
...
| `+` یا `=` / `-` | زوم‌این / زوم‌اوت اپتیک، از `x1.0` تا `x3.2` |
