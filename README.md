...
- یک سیگنالِ اصلی در شروع و هر زمان قاب برای مدتی خالی شود، در فاصلهٔ نزدیکِ حدود ۱۵۰ متر داخل محور اپتیک وارد می‌شود و در یک air lane کوچک glide می‌کند تا بدن و پرهای سه‌بعدی واقعاً خوانا بمانند. دیگر سیگنال‌ها همچنان از پشت سامانه و در laneهای کناری می‌رسند و ارتفاع/فاصلهٔ متفاوت دارند.
