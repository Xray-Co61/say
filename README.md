...
- فرشته‌ها/سیگنال‌ها کاملاً با shader و silhouetteهای رویه‌ای رسم می‌شوند؛ هیچ عکس یا textureای برای خود فرشته در بازی نیست. آن‌ها در ارتفاع ۴۸ تا ۸۶ واحدی بالای سامانه می‌گذرند، بنابراین دوربین عمداً زیرِ بال‌ها را می‌بیند.
