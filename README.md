...
- فرشته‌ها/سیگنال‌ها کاملاً با shader و silhouetteهای رویه‌ای در فاصله‌های چندصد متری رسم می‌شوند؛ هیچ عکس یا textureای برای خود فرشته در بازی نیست. مه، grain و رد حرکت، آن‌ها را به یک حضور مبهم و دور تبدیل می‌کند، نه مدل low-poly.
- اپتیک به یک برجک/سامانهٔ واقعی محدود شده است: میدان دید در حالت عادی ۲۰ درجه است، زوم تا `x2.6` می‌رود و yaw/pitch آزادِ ۳۶۰ درجه نیست.
- هدف‌ها ابتدا در میدان دید دیده می‌شوند؛ بعداً از **پشت سامانه** spawn می‌شوند و به جلو می‌گذرند. فاصلهٔ spawn دیدنی بین حدود ۴۲۰ تا ۹۸۰ متر است و رد روشن هر کدام واقعاً تاریخچهٔ حرکتش است.
- شلیک **hitscan نیست**: هر گلوله سرعت، زمان سفر، افت بالستیک و tracer خودش را دارد. fire-control فقط وقتی هدف دقیقاً lock شود، حرکت هدف و افت گلوله را برای شلیک محاسبه می‌کند؛ بیرون از lock تیر دقیقاً در امتداد اپتیک می‌رود.
