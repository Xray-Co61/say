...
- اپتیک به یک برجک/سامانهٔ واقعی محدود شده است: میدان دید در حالت عادی ۲۰ درجه است، زوم تا `x2.6` می‌رود و yaw/pitch آزادِ ۳۶۰ درجه نیست. نسخهٔ آماده هنگام اجرا تمام‌صفحهٔ native باز می‌شود تا title bar و taskbar دورِ منظره دیده نشود.
- یک سیگنالِ اصلی در شروع و هر زمان قاب برای مدتی خالی شود، داخل محور اپتیک وارد می‌شود؛ فاصلهٔ خواناترِ آن حدود ۲۱۵ تا ۳۹۰ متر است. دیگر سیگنال‌ها همچنان از پشت سامانه می‌رسند و ارتفاع/فاصلهٔ متفاوت دارند.
