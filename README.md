...
- فرشته‌ها/سیگنال‌ها از هندسهٔ سه‌بعدیِ procedural ساخته می‌شوند: بدن حجمی، ۲۸ پرِ جداگانه در هر بال، لایهٔ پرهای پوششی و دمِ بادبزنی. هیچ عکس یا textureای برای خود فرشته در بازی نیست. آن‌ها در ارتفاع ۴۸ تا ۸۶ واحدی بالای سامانه می‌گذرند، بنابراین دوربین عمداً زیرِ بال‌ها را می‌بیند.
...
- هدف‌ها در فاصلهٔ خواناترِ حدود ۲۳۰ تا ۴۶۰ متر ظاهر می‌شوند؛ هنوز برای تأخیر شلیک و حرکت هدف کافی دورند، اما دیگر به نقطه‌های گم‌شده در افق تبدیل نمی‌شوند.
